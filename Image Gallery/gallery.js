/*I decided to use event delegation for the sake of performance 
whereby I will be adding the event on the body (the gallery-1 class)
 instead of adding it to the animal cards*/
